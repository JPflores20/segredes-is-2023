...
```
LINK: https://artifacts.picoctf.net/c/287/SafeOpener.class

```
## Solución

```bash
1:Entramos al siguiente link para decompílar el archivo .class: http://www.javadecompilers.com/result
2: Nos aparece el siguiente resultado con la bandera dentro:
