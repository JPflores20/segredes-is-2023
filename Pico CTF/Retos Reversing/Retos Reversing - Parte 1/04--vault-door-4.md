...
```
LINK: https://jupiter.challenges.picoctf.org/static/09d3002ae349631324a17e2255ae8df2/VaultDoor4.java
...
```bash
─(kali㉿kali)-[~]
└─$ cd /home/kali/Documents/Retos/REVERSING/vault-door-4/
                                                                                                    
┌──(kali㉿kali)-[~/Documents/Retos/REVERSING/vault-door-4]
└─$ wget https://jupiter.challenges.picoctf.org/static/09d3002ae349631324a17e2255ae8df2/VaultDoor4.java
--2023-11-08 00:27:48--  https://jupiter.challenges.picoctf.org/static/09d3002ae349631324a17e2255ae8df2/VaultDoor4.java
...
2023-11-08 00:27:48 (39.9 MB/s) - ‘VaultDoor4.java’ saved [1497/1497]
...
┌──(kali㉿kali)-[~/Documents/Retos/REVERSING/vault-door-4]
└─$ jsva VaultDoor4.     
Command 'jsva' not found, did you mean:
  command 'jsvn' from deb svnkit
  command 'jsvc' from deb jsvc
